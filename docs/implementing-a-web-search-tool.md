...
> I have experimented with this call in `src/tools-concepts.py` in the accompanying [code repo](https://github.com/rob212/rob-agent/tree/main/src/tools-concepts.py) if you want to try the same.
...
See Tavily docs for more detailed information: [https://docs.tavily.com/documentation/api-reference/endpoint/search](https://docs.tavily.com/documentation/api-reference/endpoint/search)
...
This problem is where Model Context Protocol (MCP) attempts to provide a solution. [MCP is the concept we will explore next](mcp.md).
